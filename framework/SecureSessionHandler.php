...
class SecureSessionHandler extends SessionHandler {
    ...
    public function __construct($key='PieceOfCake1234567891234', $name = 'MY_SESSION', $cookie = [])
    {
		if(strlen($key)==24)
          $this->key = $key;
        else
          $this->key = 'PieceOfCake1234567891234';
...
$session = new SecureSessionHandler('PieceOfCake1234567891234');
